...
{
    /**
     * All category data lives here — one source of truth.
     * When a real report route is built, swap '#' with route('admin.reports.xxx').
     */
    private function categories(): array
    {
        ...
        return [
            ['key'=>'crm',       'name'=>'CRM Reports',          'desc'=>'Track every lead from first contact to conversion — with per-agent and source breakdowns.',          'icon'=>$icons['crm'],       'items'=>[
            ...
            ['key'=>'sales',     'name'=>'Sales & Rents Reports', 'desc'=>'Complete picture of bookings, leases, cancellations and salesperson achievement.',                   'icon'=>$icons['sales'],     'items'=>[
                ...
                ['name'=>'Reservation Reports',          'desc'=>'Temporary holds, expiry timelines and conversion to full booking.',  'route'=>'#'],
                ['name'=>'Cancellation Reports',         'desc'=>'Cancelled bookings with stated reasons and revenue impact.',         'route'=>'#'],
                ['name'=>'Salesperson Performance Reports','desc'=>'Individual sales targets vs. achievement by period.',              'route'=>'#'],
                ['name'=>'Commission Reports',           'desc'=>'Commission due, paid and pending per salesperson and booking.',      'route'=>'#'],
            ]],
            ['key'=>'finance',   'name'=>'Finance Reports',       'desc'=>'Full financial reporting suite — from daily transactions to annual balance sheet and tax.',          'icon'=>$icons['finance'],   'items'=>[
            ...
            ['key'=>'project',   'name'=>'Project Reports',       'desc'=>'Monitor project health, budget adherence, resource use and contractor progress.',                   'icon'=>$icons['project'],   'items'=>[
            ...
            ['key'=>'marketing', 'name'=>'Marketing Reports',     'desc'=>'Measure the reach, engagement and ROI of every campaign across email, SMS and ads.',                'icon'=>$icons['marketing'], 'items'=>[
            ...
            ['key'=>'hr',        'name'=>'HR Reports',            'desc'=>'People data — attendance, leave, payroll and performance in one place.',                            'icon'=>$icons['hr'],        'items'=>[
            ...
            ['key'=>'inventory', 'name'=>'Inventory Reports',     'desc'=>'Track stock levels, purchases, supplier dues and material consumption across warehouses.',          'icon'=>$icons['inventory'], 'items'=>[
            ...
            ['key'=>'document',  'name'=>'Document Reports',      'desc'=>'Monitor document compliance, identify missing files and review the full audit trail.',              'icon'=>$icons['document'],  'items'=>[
            ...
            ['key'=>'custom',    'name'=>'Custom Reports',        'desc'=>'Build, save, schedule and share your own reports using any combination of data fields.',            'icon'=>$icons['custom'],    'items'=>[
