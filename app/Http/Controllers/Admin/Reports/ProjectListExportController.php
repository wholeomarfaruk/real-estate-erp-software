...
{
    public function __construct(private ProjectListService $service) {}
    ...
    public function pdf(Request $request): Response
    {
        ...
        $pdf = Pdf::loadView('pdf.reports.projects.project-list-pdf', [
            'report' => $payload,
    ...
    public function print(Request $request): View
    {
        ...
        return view('pdf.reports.projects.project-list-print-standalone', [
    ...
    public function excel(Request $request): Response
    {
        ...
        $content = view('pdf.reports.projects.project-list-excel', [
            'report' => $payload,
        ])->render();
