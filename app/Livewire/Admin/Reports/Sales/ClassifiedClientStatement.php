...
class ClassifiedClientStatement extends Component
{
    ...
    public function mount(ClassifiedClientStatementService $service): void
    {
        $this->authorizePermission('reports.sales.classified-client-statement.view');
    ...
    public function render(ClassifiedClientStatementService $service): View
    {
        $this->authorizePermission('reports.sales.classified-client-statement.view');

        $report = $service->build($this->filterPayload());

        return view('livewire.admin.reports.sales.classified-client-statement', [
            'report' => $report,
            'projects' => $service->getProjects(),
            'customers' => $service->getCustomers(),
            'properties' => $service->getProperties(),
            'printUrl' => route('admin.reports.sales.classified.print', $this->exportQuery()),
            'printStandaloneUrl' => route('admin.reports.sales.classified.print-standalone', $this->exportQuery()),
            'pdfUrl' => route('admin.reports.sales.classified.pdf', $this->exportQuery()),
            'excelUrl' => route('admin.reports.sales.classified.excel', $this->exportQuery()),
