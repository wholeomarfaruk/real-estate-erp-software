...
<head>
    ...
    <style>
        * { font-family: "DejaVu Sans", sans-serif; box-sizing: border-box; }
        ...
        body {
            font-size: 8px; color: var(--ink); margin: 0; padding: 0;
        ...
        .table thead th {
            background: var(--zebra); color: var(--ink); font-size: 7px; font-weight: bold;
            letter-spacing: .2px; text-transform: uppercase; padding: 4px 3px; border: 1px solid var(--ink);
            word-wrap: break-word;
        }
        .table tbody td {
            padding: 4px 3px; font-size: 7.5px; border: 1px solid var(--rule);
