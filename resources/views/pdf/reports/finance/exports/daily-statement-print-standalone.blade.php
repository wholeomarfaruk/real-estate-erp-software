{{--
  Daily Statement Report · Print template (Browser-friendly)
--}}
@php
...
<style>
  * { font-family:"Segoe UI", Arial, sans-serif; box-sizing:border-box; }
  body{ font-size:11px; color:#161616; margin:0; padding:20px;
        -webkit-print-color-adjust:exact; print-color-adjust:exact; background:#f9f9f9; }

  .sheet{ padding:14mm 13mm; background:#fff; margin:20px auto; max-width:210mm;
  ...
  .num{ font-family:"Courier New", monospace; text-align:right; white-space:nowrap; font-size:9.5px; }
  .num-zero{ color:#8a8a8a; }
  .sn{ text-align:center; color:#5f5f5f; font-family:"Courier New", monospace; }
