<table border="1">
    ...
    <tbody>
        ...
        @if (count($report['rows']) > 0)
            <tr></tr>
            <tr>
                <td colspan="7" style="font-weight:bold;">Total ({{ $report['summary']['total_projects'] }} projects)</td>
                <td style="font-weight:bold;">{{ number_format((float) $report['summary']['total_budget'], 0, '.', '') }}</td>
                <td></td>
                <td style="font-weight:bold;">{{ $report['summary']['total_properties'] }}</td>
