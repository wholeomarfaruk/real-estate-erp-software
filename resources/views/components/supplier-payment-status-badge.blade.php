...
@php
    ...
    [$label, $classes] = match ($normalized) {
        ...
        'posted' => ['Posted', 'bg-blue-100 text-blue-700'],
        'partial_allocated' => ['Partial Allocated', 'bg-amber-100 text-amber-700'],
        'fully_allocated' => ['Fully Allocated', 'bg-green-100 text-green-700'],
