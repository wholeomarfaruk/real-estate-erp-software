...
<body x-data class="mx-auto antialiased flex justify-between">
    ...
    @php
        ...
        $sidebarActiveGroup = match(true) {
            ...
            str_starts_with($currentRoute, 'admin.reports')    => 'reports',
        ...
        document.addEventListener('alpine:init', () => {
            ...
            Alpine.data('dropdown', (key = null) => ({
                ...
                init() {
                    ...
                    // Close this dropdown whenever the active group changes to something else
                    this.$watch('$store.sidebar.active', (val) => {
                        if (key && val !== key) {
                            this.open = false;
                        }
                    });
                ...
                toggle(tab) {
                    const isAlreadyActive = Alpine.store('sidebar').active === tab;
                    Alpine.store('sidebar').active = tab;
                    this.open = isAlreadyActive ? !this.open : true;
                },
