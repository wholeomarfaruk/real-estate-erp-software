            ...
            <table class="min-w-full">
                ...
                <tbody class="divide-y divide-gray-100">
                    @forelse ($rows as $row)
                        <tr>
                            <td class="px-4 py-3">
                                <p class="text-sm font-medium text-gray-800">{{ $row->product_name }}</p>
                                <p class="text-xs text-gray-500">{{ $row->product_sku ?: 'No SKU' }}</p>
                            </td>
                    ...
                    @empty
                        <tr>
                            <td colspan="4" class="px-4 py-12 text-center">
                                <p class="text-sm font-medium text-gray-700">No product stock summary found.</p>
