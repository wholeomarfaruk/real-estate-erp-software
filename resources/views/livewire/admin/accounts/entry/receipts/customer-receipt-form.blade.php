<div class="max-w-[700px] mx-auto px-4 py-6">
    <style>
        :root { --gap: 0.6rem; --padding: 0.9rem; }
    ...
    <form wire:submit="save" class="form-container">
        <div class="form-header">
            <h1>Record Customer Receipt</h1>
            <p>Create a customer payment receipt entry</p>
        </div>
        ...
        <div class="form-body">
            <div class="form-group">
                ...
                @error('debit_account_id') <div class="error-text">{{ $message }}</div> @enderror
            </div>
            ...
            <div class="form-group">
                ...
                @error('credit_account_id') <div class="error-text">{{ $message }}</div> @enderror
            </div>
            ...
            <div class="form-row">
                ...
                <div class="form-group">
                    ...
                    <input type="text" wire:model="reference_no" placeholder="Invoice or receipt no." />
                </div>
            </div>
