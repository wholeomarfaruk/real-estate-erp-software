<div x-data x-init="$store.pageName = { name: 'Product Wise Cost', slug: 'accounts-product-wise-cost' }">
    <div class="flex flex-wrap items-start justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">Accounts module product cost summary.</p>
        </div>
