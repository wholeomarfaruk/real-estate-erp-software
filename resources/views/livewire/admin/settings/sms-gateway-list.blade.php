                        ...
                        <tr class="hover:bg-gray-50 transition">
                            ...
                            <td class="px-6 py-4 text-sm">
                                <span class="px-3 py-1 rounded-full text-xs font-semibold
                                    ...
                                    @elseif ($gateway->provider === 'reve_sms')
            ...
            <form @submit.prevent="$wire.save()" class="space-y-4">
                ...
                <div>
                    ...
                    <div class="space-y-2">
                        ...
                        <label class="flex items-center">
                            <input type="radio" wire:model="fProvider" value="reve_sms"
                                class="w-4 h-4">
                            <span class="ml-2 text-sm text-gray-700">REVE SMS</span>
                        </label>
                    </div>
                ...
                <div x-show="$wire.fProvider === 'reve_sms'" x-transition class="space-y-3">
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">API Key</label>
                        <input type="password" wire:model="fReveApiKey"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Your REVE SMS API key">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Secret Key</label>
                        <input type="password" wire:model="fReveSecretKey"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="Your REVE SMS secret key">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Sender ID</label>
                        <input type="text" wire:model="fReveSenderId"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="e.g. Star Unity">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Submit URL</label>
                        <input type="text" wire:model="fReveSubmitUrl"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="https://smpp.revesms.com/smsapi/sendtext">
                    </div>
                    <div>
                        <label class="block text-sm font-medium text-gray-700 mb-1">Status Check URL</label>
                        <input type="text" wire:model="fReveStatusUrl"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="https://smpp.revesms.com/smsapi/status">
                    </div>
                    <p class="text-xs text-amber-600">Verify Submit/Status URLs against your REVE panel's HTTP API configuration page — REVE endpoints can be account-specific.</p>
                </div>
