                ...
                <div x-show="$wire.fProvider === 'reve_sms'" x-transition class="space-y-3">
                    ...
                    <div>
                        ...
                        <input type="text" wire:model="fReveStatusUrl"
                            class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm"
                            placeholder="https://smpp.revesms.com:7790/getstatus">
                    </div>
                    <p class="text-xs text-gray-500">Verified against the "SMS Client Technical Details" panel for this account (Request Type: JSON, port 7790). If REVE changes the port/host for this account, update it here.</p>
                </div>
