        ...
        <div class="w-full max-w-2xl rounded-lg bg-white p-6 shadow-lg">
            ...
            <form wire:submit.prevent="saveAdvance" class="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <input type="date" wire:model.defer="advance_date" class="mt-1 h-10 w-full rounded-lg border border-gray-300 px-3 text-sm focus:border-indigo-500 focus:outline-none flatpickr-only-date">
