        ...
        <div class="rounded-2xl border border-gray-200 bg-white">
            <div class="px-5 py-4 sm:px-6 sm:py-5">
                <x-form-section submit="save">
                    ...
                    <x-slot name="description">Provide unit details.</x-slot>
                    ...
                    <x-slot name="form">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            <x-label for="floor_id" value="Floor" />
                            <select wire:model="floor_id" id="floor_id" class="mt-1 block w-full rounded-md border-gray-300 shadow-sm">
                        ...
                        <div class="col-span-6 sm:col-span-3">
                            ...
                            <x-input wire:model="unit_number" id="unit_number" type="text" class="mt-1 block w-full" placeholder="e.g. A-101" />
                            <x-input-error for="unit_number" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <x-label for="unit_name" value="Unit Name" />
                            <x-input wire:model="unit_name" id="unit_name" type="text" class="mt-1 block w-full" placeholder="Optional name" />
                            <x-input-error for="unit_name" class="mt-2" />
                        </div>

                        <div class="col-span-6 sm:col-span-3">
                            <x-label for="unit_type" value="Unit Type" />
                            <x-input wire:model="unit_type" id="unit_type" type="text" class="mt-1 block w-full" placeholder="e.g. residential" />
                    ...
                    <x-slot name="actions">
                        ...
                        <a href="{{ route('admin.units.list') }}" class="ml-3 inline-flex items-center px-4 py-2 border rounded-md text-sm font-medium text-gray-700 bg-white hover:bg-gray-50">Cancel</a>
                    </x-slot>
                </x-form-section>
            </div>
        </div>
