                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center gap-2">
                                                <div class="inline-flex">
                                                    <button wire:click="openViewModal({{ $project->id }})"
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:text-left w-full">
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                ...
                                <div>
                                    ...
                                    <div class="space-y-2 text-sm">
                                        <p><strong>Start Date:</strong> {{ $selectedProject->start_date->format('M d, Y') }}</p>
                                        <p><strong>End Date:</strong> {{ $selectedProject->end_date->format('M d, Y') }}</p>
                            ...
                            <div class="mt-6">
                                ...
                                <div class="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    <div class="bg-gray-50 p-3 rounded-lg">
                                        <div class="text-2xl font-bold text-blue-600">{{ $selectedProject->floors->count() }}</div>
                                        <div class="text-sm text-gray-600">Floors</div>
                                    </div>
                                    <div class="bg-gray-50 p-3 rounded-lg">
                                        <div class="text-2xl font-bold text-green-600">{{ $selectedProject->units->count() }}</div>
                                        <div class="text-sm text-gray-600">Units</div>
                                    </div>
                                    <div class="bg-gray-50 p-3 rounded-lg">
                                        <div class="text-2xl font-bold text-purple-600">{{ $selectedProject->units->where('availability_status', 'available')->count() }}</div>
                                        <div class="text-sm text-gray-600">Available Units</div>
                                    </div>
                                    <div class="bg-gray-50 p-3 rounded-lg">
                                        <div class="text-2xl font-bold text-orange-600">{{ $selectedProject->units->where('availability_status', 'sold')->count() }}</div>
