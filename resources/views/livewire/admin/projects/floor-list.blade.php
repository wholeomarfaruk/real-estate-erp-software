                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <div class="flex items-center gap-2">
                                                <div class="inline-flex">
                                                    <a href="{{ route('admin.floors.view', $floor->id) }}" class="-ml-px border border-gray-200 px-3 py-2 font-medium text-gray-700 transition-colors hover:bg-gray-50 hover:text-gray-900">View</a>
                                                    @can('project.edit')
