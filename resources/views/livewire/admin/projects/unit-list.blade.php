...
<div x-data x-init="$store.pageName = { name: 'Units Management', slug: 'units' }">
        ...
        <div class="rounded-2xl border border-gray-200 bg-white dark:border-gray-800 dark:bg-white/[0.03]">
            <div class="px-5 py-4 sm:px-6 sm:py-5">
                <div class="flex items-center justify-between">
                    <div class="flex gap-4">
                        ...
                        <div class="flex gap-2">
                            <select wire:model.live="selectedProject"
                                class="rounded-lg border border-gray-300 bg-white px-3 py-2 text-sm shadow-theme-xs focus:border-brand-300 focus:ring-brand-500/10 dark:border-gray-700 dark:bg-gray-900 dark:text-white/90">
                    ...
                    <div>
                        <input type="text" wire:model.live.debounce="search" placeholder="Search units..."
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-5 py-4 sm:px-6">
                                            <span class="inline-block px-2 py-1 text-xs font-medium rounded-full
                                                @if($unit->availability_status === 'sold') bg-green-100 text-green-800
                                                @elseif($unit->availability_status === 'booked') bg-blue-100 text-blue-800
                                                @elseif($unit->availability_status === 'reserved') bg-yellow-100 text-yellow-800
                                                @elseif($unit->availability_status === 'handover') bg-purple-100 text-purple-800
                                                @else bg-gray-100 text-gray-800 @endif">
                                                {{ ucfirst($unit->availability_status) }}
                                            </span>
                                        </td>
                                        <td class="px-5 py-4 sm:px-6">
